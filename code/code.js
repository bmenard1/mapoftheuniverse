...
(function () {
    ...
    on('.bottom-arrow', 'click', function () {
        ...
        if (top && bot) {
            ...
            // User-tuned bias: shift up by 0.25× the rendered height of the
            // "you are here" label (i.e., scroll slightly less than the band midpoint).
            // bot.offsetHeight respects any responsive font-size overrides.
            scrollTarget = baseTarget - 0.25 * bot.offsetHeight;
        } else {
